...
/**
 * The primary key class for the CAREER_EXIT database table.
 * 
 */
@Embeddable
public class CareerExitPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CareerExitPK)) {
			return false;
		}
		CareerExitPK castOther = (CareerExitPK)other;
		return 
